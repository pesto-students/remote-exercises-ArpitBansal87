...
describe('curry', () => {
  ...
  test('Check for use of curry in equation', () => {
    const equationResult = curry((x, y) => x * 2 + 3 * y + 2);
    const equationResultObj = equationResult(1);
    expect(equationResultObj(3)).toBe(13);
  });
});
